...
reformat4t['SOFA'] = newcols_reformat4[:,-1]
#PaO2
reformat4t['SOFA1'] = newcols_reformat4[:, 0]
#Plateltes
reformat4t['SOFA2'] = newcols_reformat4[:, 1]
#Bilirubin
reformat4t['SOFA3'] = newcols_reformat4[:, 2]
#Mean arterial pressure OR administration of vasoactive agents required
reformat4t['SOFA4'] = newcols_reformat4[:, 3]
#Glacoma Scale
reformat4t['SOFA5'] = newcols_reformat4[:, 4]
#Creatinine
reformat4t['SOFA6'] = newcols_reformat4[:, 5]
...
colnorm = ['age', 'Weight_kg', 'GCS', 'HR', 'SysBP', 'MeanBP', 'DiaBP', 'RR', 'Temp_C',\
        ...
        'Arterial_BE', 'HCO3', 'Arterial_lactate', 'SOFA', 'SOFA1', 'SOFA2', 'SOFA3', 'SOFA4', 'SOFA5', 'SOFA6','SIRS', 'Shock_Index',\
